...
class Facebook_post_scrape():
    def __init__(self, page_name):
        ...
        self.token = 'EAACEdEose0cBAEsAuReZAOpWE7gd2k8wH6cjdpu8e6zHvJG1qgg0PFuZCPQdTR4ahAVlm8EYfQAnVnXaTZAvyumAcaanZCNCYBTZBdpZC24cZAyfheaWdSnArwH0IVKbbQlJwZCeuSqxm7Cqs5KlkrmjEuVH7jZC6JAIzKvj84dup0QZDZD'
    def scrape(self):
        ...
        try:
            ...
            for post in postsdata:
                ...
                for comment in comments:
                    ...
                    cur.execute("INSERT INTO facebook (message, comment_name, comment_content)\
                                VALUES (%s, %s, %s)",(message, comment['from']['name'].encode('utf-8'), comment['message'].encode('utf-8')));
                    conn.commit()
